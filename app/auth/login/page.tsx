...
export default function LoginPage() {
  ...
  const { user, isLoading: authLoading, signIn, isSupabaseConfigured } = useAuth()
  ...
  const handleGoogleLogin = async () => {
    if (!isSupabaseConfigured) {
      setError("Google login requires Supabase integration. Please add Supabase in settings.")
      return
    }
              ...
              <div className="mb-6 flex items-start gap-3 rounded-lg border border-accent/50 bg-accent/10 p-4">
                ...
                <div className="text-sm">
                  ...
                  <p className="mt-1 text-muted-foreground">
                    Your account data is stored locally. Add Supabase for cloud sync.
                  </p>
                </div>
              </div>
            )}
